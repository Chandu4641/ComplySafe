...
function run() {
  const matrixPath = "docs/verification/phase3-regression-matrix.json";
  ...
  const outputPath = resolve("docs/verification/phase3-regression-report.json");
