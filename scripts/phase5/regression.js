...
function run() {
  const matrixPath = "docs/verification/phase5-regression-matrix.json";
  ...
  const outputPath = resolve("docs/verification/phase5-regression-report.json");
